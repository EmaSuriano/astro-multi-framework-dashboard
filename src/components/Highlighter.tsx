...
export const HighlighterToggle = () => {
  ...
  return (
    <div className="tw-text-white">
      <button
        type="button"
        className="tw-absolute tw-right-10 tw-transition-all tw-drop-shadow-lg hover:tw-drop-shadow-xl tw-bottom-10 tw-text-white tw-bg-blue-500 hover:tw-bg-blue-800 focus:tw-ring-4 focus:tw-outline-none focus:tw-ring-blue-300 tw-font-medium tw-rounded-full tw-text-sm tw-p-4 tw-text-center tw-inline-flex tw-items-center tw-mr-2 dark:tw-bg-blue-600 dark:hover:tw-bg-blue-700 dark:focus:tw-ring-blue-800"
